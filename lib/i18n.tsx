...
export const translations = {
  en: {
    home: {
      ...
      statisticsSubtitle: "For data lovers and list enthusiasts",
      statsColumns: {
        station: "Station",
      ...
      selectLines: "Select the lines and difficulty level to train on",
    ...
    results: {
      ...
      inARow: "in a row",
      leaderboard: "Leaderboard",
      registerScore: "Show my scores",
      newBest: "New best score!",
      enterName: "Your name",
      enterNameHint: "Enter a name to show your scores",
      saveScore: "Save",
  ...
  fr: {
    home: {
      ...
      statisticsSubtitle: "Pour les amoureux des données et des listes",
      statsColumns: {
        station: "Station",
      ...
      selectLines: "Sélectionnez les lignes et le niveau de difficulté",
    ...
    results: {
      ...
      inARow: "d'affilée",
      leaderboard: "Classement",
      registerScore: "Afficher mes scores",
      newBest: "Nouveau record !",
      enterName: "Votre nom",
      enterNameHint: "Entrez un nom pour afficher vos scores",
      saveScore: "OK",
